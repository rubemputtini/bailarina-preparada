...
interface ImageWithPlaceholderProps {
  ...
  /** "cover" (padrão) recorta para preencher o espaço; "contain" mostra a imagem inteira, sem cortes. */
  fit?: "cover" | "contain";
}
...
export function ImageWithPlaceholder({
  ...
  if (src) {
    return <img src={src} alt={alt} className={cn(fit === "contain" ? "object-contain" : "object-cover", className)} />;
  }
  return (
